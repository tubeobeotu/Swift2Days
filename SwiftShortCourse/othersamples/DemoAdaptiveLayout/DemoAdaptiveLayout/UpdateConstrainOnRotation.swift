...
class UpdateConstrainOnRotation: UIViewController {
    ...
    func portraitConstraint() {
        ...
        //Vertical space:
        c1 = NSLayoutConstraint.constraintsWithVisualFormat("V:|-40.0-[blueRect]-10.0-[orangeRect]-40.0-|", options: [], metrics: nil, views: views)
        self.view.addConstraints(c1!)
        
        c2 = NSLayoutConstraint.constraintsWithVisualFormat("H:|-40.0-[blueRect]-40.0-|", options: [], metrics: nil, views: views)
        self.view.addConstraints(c2!)
        
        c3 = NSLayoutConstraint.constraintsWithVisualFormat("H:|-40.0-[orangeRect]-40.0-|", options: [], metrics: nil, views: views)
    ...
    func landscapeConstraint() {
        let views = ["view": self.view, "blueRect": blueRect!, "orangeRect": orangeRect!]
        //Horizonal space:
        c_1 = NSLayoutConstraint.constraintsWithVisualFormat("H:|-40.0-[blueRect]-10.0-[orangeRect]-40.0-|", options: [], metrics: nil, views: views)
        self.view.addConstraints(c_1!)
        
        c_2 = NSLayoutConstraint.constraintsWithVisualFormat("V:|-40.0-[blueRect]-40.0-|", options: [], metrics: nil, views: views)
        self.view.addConstraints(c_2!)
        
        c_3 = NSLayoutConstraint.constraintsWithVisualFormat("V:|-40.0-[orangeRect]-40.0-|", options: [], metrics: nil, views: views)
