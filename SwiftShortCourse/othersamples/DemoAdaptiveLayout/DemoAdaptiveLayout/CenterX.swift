...
class CenterX: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //| cạnh ngang hoặc dọc
        self.view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("H:[blueRect(100)]", options: NSLayoutFormatOptions(), metrics: nil, views: views))  //blueRect có chiều rộng là 100 point
        
        self.view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:[blueRect(50)]", options: NSLayoutFormatOptions(), metrics: nil, views: views))  //blueRect có chiều cao là 50 point
        ...
        self.view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:[blueRect]-40.0-|", options: NSLayoutFormatOptions(), metrics: nil, views: views))//blueRect cách đáy 40 point
