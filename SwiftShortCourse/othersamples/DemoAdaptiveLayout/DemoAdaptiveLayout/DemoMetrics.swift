...
class DemoMetrics: UIViewController {
    override func loadView() {
        ...
        self.view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:|-Vspace-[blueRect]-Vspace-|", options: [], metrics: metric, views: views))
        

        self.view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("H:|-Hspace-[blueRect]-Hspace-|", options: [], metrics: metric, views: views))
    }
}
