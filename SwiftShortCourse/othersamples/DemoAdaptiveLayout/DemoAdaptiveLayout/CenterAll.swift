...
class CenterAll: UIViewController {
    override func loadView() {
        ...
        self.view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:|-40.0-[blueRect]-40.0-|", options: NSLayoutFormatOptions(), metrics: nil, views: views))
        
        //Horizontal space: cách left, cách right 40 point
        self.view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("H:|-40.0-[blueRect]-40.0-|", options: NSLayoutFormatOptions(), metrics: nil, views: views))
    }
