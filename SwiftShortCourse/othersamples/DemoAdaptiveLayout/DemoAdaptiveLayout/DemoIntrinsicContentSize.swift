...
class DemoIntrinsicContentSize: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:|-10.0-[label]", options: [], metrics: nil, views: views))

        self.view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("H:|-10.0-[label]", options: [], metrics: nil, views: views))
    }
