...
class EqualWidth: UIViewController {
    ...
    override func loadView() {
        ...
        self.view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:|-40.0-[blueRect(100)]", options: [], metrics: nil, views: views))
        //Ngang 100 point
        self.view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("H:[blueRect(100)]", options: [], metrics: nil, views: views))
        //CenterX blue
        ...
        self.view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("H:[orangeRect(==blueRect)]", options: [], metrics: nil, views: blueOrange))
        //make blue and orage same height
        self.view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:[orangeRect(==blueRect)]", options: [], metrics: nil, views: blueOrange))
