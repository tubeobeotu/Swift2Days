...
class ModifyConstraint: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        cs1 = NSLayoutConstraint.constraintsWithVisualFormat("V:|-10.0-[label]", options: [], metrics: nil, views: views)
        self.view.addConstraints(cs1!)
        
        cs2 = NSLayoutConstraint.constraintsWithVisualFormat("H:|-10.0-[label]", options: [], metrics: nil, views: views)
        self.view.addConstraints(cs2!)
        
        
        cs_1 = NSLayoutConstraint.constraintsWithVisualFormat("V:[label]-10.0-|", options: [], metrics: nil, views: views)
       
        self.view.addConstraints(cs_1!)
        
        cs_2 = NSLayoutConstraint.constraintsWithVisualFormat("H:[label]-10.0-|", options: [], metrics: nil, views: views)
        ...
        button.addTarget(self, action: #selector(ModifyConstraint.flipLabel), forControlEvents: UIControlEvents.TouchUpInside)
